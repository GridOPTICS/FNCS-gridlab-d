...
[AC_COMPUTE_INT([gld_arg_parse_sizeof_voidp], [(long int) (sizeof (void*))])
for arg in $$1 ; do
    AS_CASE([$arg],
        [yes],          [],
        [no],           [],
...
# check for subdirectories e.g. lib,include
    AS_IF([test "x$gld_arg_parse_ok" = xno],
        [AS_IF([test "x$gld_arg_parse_sizeof_voidp" = x8],
            [AS_IF([test -d $arg/lib64],    [$3="$$3 -L$arg/lib64"; gld_arg_parse_ok=yes],
                   [test -d $arg/lib],      [$3="$$3 -L$arg/lib"; gld_arg_parse_ok=yes])
             AS_IF([test -d $arg/include64],[$4="$$4 -I$arg/include64"; gld_arg_parse_ok=yes],
                   [test -d $arg/include],  [$4="$$4 -I$arg/include"; gld_arg_parse_ok=yes])],
            [AS_IF([test -d $arg/lib],      [$3="$$3 -L$arg/lib"; gld_arg_parse_ok=yes])
             AS_IF([test -d $arg/include],  [$4="$$4 -I$arg/include"; gld_arg_parse_ok=yes])])])
# $arg still unknown, look for "lib" and "include" anywhere...
    AS_IF([test "x$gld_arg_parse_ok" = xno],
        [AS_CASE([$arg],
            [*lib*],    [AS_IF([test -d $arg], [$3="$$3 -L$arg"; gld_arg_parse_ok=yes])],
            [*include*],[AS_IF([test -d $arg], [$4="$$4 -I$arg"; gld_arg_parse_ok=yes])])])
